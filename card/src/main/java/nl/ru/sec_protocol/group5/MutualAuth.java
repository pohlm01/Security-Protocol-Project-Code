...
public class MutualAuth {
    ...
    void exchangeMetadata(APDU apdu) {
        ...
        Util.arrayCopy(applet.cardCounter, (short) 0, buffer, (short) (Constants.ID_SIZE + Constants.DATE_SIZE), Constants.COUNTER_SIZE);
    ...
    void activeAuthentication(APDU apdu) {
        ...
        Util.arrayCopy(applet.cardCounter, (short) 0, applet.transientData, (short) (Constants.OFFSET_PUB_KEY + Constants.COUNTER_SIZE + Constants.DATE_SIZE), Constants.COUNTER_SIZE);
