...
public class Reload {
    ...
    void verifyAmount(APDU apdu) {
        ...
        Util.arrayCopy(applet.currentDate, (short) 0, applet.transientData, (short) (Constants.ID_SIZE + Constants.COUNTER_SIZE + 4 + Constants.ID_SIZE), Constants.DATE_TIME_SIZE);
        applet.utils.sign(applet.transientData, (short) 0, (short) (Constants.ID_SIZE + Constants.COUNTER_SIZE + 4 + Constants.ID_SIZE + Constants.DATE_TIME_SIZE), buffer, (short) 0, applet.cardPrivKey);
